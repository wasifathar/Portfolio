...
const DecayCard = ({ width = 300, height = 400, image = 'https://picsum.photos/300/400?grayscale', children }: DecayCardProps) => {
  ...
  const [filterId] = useState(() => `imgFilter-${Math.random().toString(36).substr(2, 9)}`);
  ...
  return (
    <div className="decay-card-content" style={{ width: `${width}px`, height: `${height}px` }} ref={svgRef}>
